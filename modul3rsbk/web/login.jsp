...
<body background = "bg2.png" >
    <div class="container">
        <div class="jumbotron row">
          ...
          <h4>Modul RSBK - Kelompok39</h4></center>
        </div>
        <div class="row content">
          <div class="col-md-12">
            <div class="col-md-4 col-md-offset-4 daftar">
                <p class="form-title"><font color="white"size="6">Sign In</font></p>
              <form method="POST" action="/modul3rsbk/LoginServlet" class="login">
                <div class="form-group">
                    <label><font color="white">Identitas</font></label>
